...
* Two key types of fuel cell: PEM and SOFC [Hug, 4][Hug]
* Reversible fuel cells can be used to store electricity (H2 is generated by use of electricity; the fuel cell uses H2 to produce electrical energy again) [Hug, 4][Hug]
